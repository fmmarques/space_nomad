...
function(find_yage_library _root_dir)
  ...
  if (${YAGE_LIBRARY} STREQUAL "YAGE_LIBRARY-NOT_FOUND")
	  message(SEND_ERROR "Couldn't find the yage library from \"${YAGE_ROOT_DIR}")
    message(TRACE "Findyage.cmake::find_yage_library: exit.")
  endif()
  message(TRACE "Findyage.cmake::find_yage_library: setting YAGE_LIBRARY in PARENT_SCOPE.")
...
function(find_yage_include_dir _root_dir)
  ...
  message(TRACE "Findyage.cmake::find_yage_include_dir: setting YAGE_INCLUDE_DIR in PARENT_SCOPE.")
...
if (NOT DEFINED ${YAGE_ROOT_DIR} AND NOT DEFINED ENV{YAGE_ROOT_DIR})
  ...
  set(YAGE_ROOT_DIR ${CMAKE_CURRENT_SOURCE_DIR}/dependencies/yage CACHE PATH "yage's root directory")
endif()
